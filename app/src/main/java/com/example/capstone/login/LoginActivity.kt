...
class LoginActivity : AppCompatActivity() {
    ...
    private fun updateApiService(token: String) {
        // Pastikan menggunakan ApiConfig yang benar untuk mendapatkan API Service
        val repository = Injection.provideRepository(applicationContext)
        repository.updateAuthApiService(ApiConfig.getDefaultApiService(token)) // Mengupdate API service dengan token yang baru
    }
